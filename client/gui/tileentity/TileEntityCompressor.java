...
import mod_TFmaterials.client.gui.slot.RecipesCompressor;
...
public class TileEntityCompressor extends TileEntity implements ISidedInventory, net.minecraftforge.common.ISidedInventory
{
    ...
    {
        return this.isInvNameLocalized() ? this.field_94130_e : "Compressor";
    }
    ...
    public void readFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        if (par1NBTTagCompound.hasKey("Compressor"))
        {
            this.field_94130_e = par1NBTTagCompound.getString("Compressor");
        }
    }
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                Compressor.updateCompressorBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack itemstack = RecipesCompressor.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
