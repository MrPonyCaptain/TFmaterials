...
public class GuiNuclearLamp extends GuiContainer
{
    private TileEntityNuclearLamp furnaceInventory;

    public GuiNuclearLamp(InventoryPlayer par1InventoryPlayer, TileEntityNuclearLamp par2TileEntityFurnace)
    {
        super(new ContainerNuclearLamp(par1InventoryPlayer, par2TileEntityFurnace));
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
    {
        ...
        this.mc.renderEngine.bindTexture("/gui/NuclearLamp.png");
        ...
        if (this.furnaceInventory.isBurning())
        {
            ...
            this.drawTexturedModalRect(k + 38, l + 40 + 12 - i1, 176, 12 - i1, 14, i1 + 2);
        }
