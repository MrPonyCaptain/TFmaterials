package mod_TFmaterials.client.gui.slot;
...
public class FurnaceRecipesTF
{
    private static final FurnaceRecipesTF smeltingBase = new FurnaceRecipesTF();
     ...
     */
    public static final FurnaceRecipesTF smelting()
    {
        return smeltingBase;
    }

    private FurnaceRecipesTF()
    {
        ...
        this.addSmelting(mod_TFmaterials.CopperOre.blockID, new ItemStack(mod_TFmaterials.CopperIngot), 1);
        this.addSmelting(mod_TFmaterials.UraniumOre.blockID, new ItemStack(mod_TFmaterials.UraniumIngot), 1);
        this.addSmelting(mod_TFmaterials.TinOre.blockID, new ItemStack(mod_TFmaterials.TinIngot), 1);
        this.addSmelting(mod_TFmaterials.SilverOre.blockID, new ItemStack(mod_TFmaterials.SilverIngot), 1);
        this.addSmelting(mod_TFmaterials.PlatinumOre.blockID, new ItemStack(mod_TFmaterials.PlatinumIngot), 1);
        this.addSmelting(mod_TFmaterials.PlutoniumOre.blockID, new ItemStack(mod_TFmaterials.PlutoniumIngot), 1);
    }
