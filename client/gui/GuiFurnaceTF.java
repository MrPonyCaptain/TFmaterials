...
public class GuiFurnaceTF extends GuiContainer
{
    private TileEntityNuclearFurnace furnaceInventory;

    public GuiFurnaceTF(InventoryPlayer par1InventoryPlayer, TileEntityNuclearFurnace par2TileEntityFurnace)
    {
        super(new ContainerNuclearFurnace(par1InventoryPlayer, par2TileEntityFurnace));
