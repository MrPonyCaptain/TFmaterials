...
import mod_TFmaterials.Items.*;
import mod_TFmaterials.core.proxy.CommonProxy;
import mod_TFmaterials.core.util.WorldProviderTF;

public class ItemFlintAndSteelTF extends Item
{
    public ItemFlintAndSteelTF(int par1)
    {
        super(par1);
        this.maxStackSize = 1;
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
    {
        ...
        else
        {
            ...
            if (i1 == 0)
            {
                ...
                par3World.setBlock(par4, par5, par6, mod_TFmaterials.FireTF.blockID);
            }
    ...
    {
    	itemIcon = iconRegister.registerIcon("TFmaterials:MagicFlintSteel");
    }
}
