...
{
    protected EnumToolMaterialTF theToolMaterial;

    public ItemHoe(int par1, EnumToolMaterialTF par2EnumToolMaterialTF)
    {
        super(par1);
        this.theToolMaterial = par2EnumToolMaterialTF;
        this.maxStackSize = 1;
