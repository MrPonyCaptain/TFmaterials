...
public class ItemPickaxe extends ItemToolTF
{
    /** an array of the blocks this pickaxe is effective against */
    public static final Block[] blocksEffectiveAgainst = new Block[] {Block.cobblestone, Block.stoneDoubleSlab, Block.stoneSingleSlab, Block.stone, Block.sandStone, Block.cobblestoneMossy, Block.oreIron, Block.blockIron, Block.oreCoal, Block.blockGold, Block.oreGold, Block.oreDiamond, Block.blockDiamond, Block.ice, Block.netherrack, Block.oreLapis, Block.blockLapis, Block.oreRedstone, Block.oreRedstoneGlowing, Block.rail, Block.railDetector, Block.railPowered, Block.railActivator, mod_TFmaterials.RubyOre, mod_TFmaterials.SapphireOre, mod_TFmaterials.CopperOre, mod_TFmaterials.UraniumOre, mod_TFmaterials.TinOre, mod_TFmaterials.SilverOre, mod_TFmaterials.PlutoniumOre, mod_TFmaterials.ChrystalOre, mod_TFmaterials.AmethystOre, mod_TFmaterials.AquamarineOre};

    public ItemPickaxe(int par1, EnumToolMaterialTF par2EnumToolMaterialTF)
    {
        super(par1, 2, par2EnumToolMaterialTF, blocksEffectiveAgainst);
    }
