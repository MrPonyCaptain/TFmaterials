...
public class BlockFireTF extends BlockFire {
	private int[] chanceToEncourageFire = new int[256];
	private int[] abilityToCatchFire = new int[256];
	@SideOnly(Side.CLIENT)
	private Icon[] iconArray;

	public BlockFireTF(int par1) {
		super(par1);
	...
	public void onBlockAdded(World par1World, int par2, int par3, int par4) {
		...
		if ((par1World.getBlockId(par2, par3 - 1, par4) != Block.blockDiamond.blockID)
				|| (!BlockTFportal.tryToCreatePortal(par1World, par2, par3, par4))) {
			if ((!par1World.doesBlockHaveSolidTopSurface(par2, par3 - 1, par4))
					&& (!canNeighborBurn(par1World, par2, par3, par4))) {
				par1World.setBlockToAir(par2, par3, par4);
			} else {
	...
	public void randomDisplayTick(World par1World, int par2, int par3,
		...
		if ((!par1World.doesBlockHaveSolidTopSurface(par2, par3 - 1, par4))
				&& (!mod_TFmaterials.FireTF.canBlockCatchFire(par1World, par2,
						par3 - 1, par4, ForgeDirection.UP))) {
			if (mod_TFmaterials.FireTF.canBlockCatchFire(par1World, par2 - 1,
			...
			if (mod_TFmaterials.FireTF.canBlockCatchFire(par1World, par2, par3,
			...
			if (mod_TFmaterials.FireTF.canBlockCatchFire(par1World, par2,
	...
	public void registerIcons(IconRegister par1IconRegister) {
		this.iconArray = new Icon[] {
				par1IconRegister.registerIcon("TFmaterials:TFfire_0"),
				par1IconRegister.registerIcon("TFmaterials:TFfire_1") };
	}
