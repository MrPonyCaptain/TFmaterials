...
public class BlockItadtalOre extends Block{
private int itemToDrop;

public static BlockItadtalOre block;
...
public BlockItadtalOre(int i, int itemid)
{
...
{
    this.blockIcon = iconRegister.registerIcon("TFmaterials:ItadtalOre");
}
}
