...
public static BlockPlutoniumOre block;
...
public BlockPlutoniumOre(int i)
{
...
{
    this.blockIcon = iconRegister.registerIcon("TFmaterials:PlutoniumOre");
}

public void onBlockDestroyedByPlayer(World world, int x, int y, int z, int meta){
	this.dropXpOnBlockBreak(world, x, y, z, 5);
}
}
