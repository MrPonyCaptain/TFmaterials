...
import mod_TFmaterials.core.util.method.TeleporterTF;
...
{
public BlockTFportal(int par1)
{
super(par1, "TFmaterials:TFPortal", Material.portal, false);
...
for (i1 = -1; i1 <= 3; ++i1)
{
         ...
         else if (j1 != 0 && j1 != mod_TFmaterials.FireTF.blockID)
         {
         return false;
         }
         }
...
for (i1 = 0; i1 < 3; ++i1)
{
         par1World.setBlock(par2 + b0 * l, par3 + i1, par4 + b1 * l, mod_TFmaterials.TFportal.blockID, 0, 2);
}
}
return true;
}
...
if ((par5Entity.ridingEntity == null) && (par5Entity.riddenByEntity == null) && ((par5Entity instanceof EntityPlayerMP)))
         ...
         else if (thePlayer.dimension != mod_TFmaterials.dimension)
         {
                 thePlayer.timeUntilPortal = 10;
                 thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, mod_TFmaterials.dimension, new TeleporterTF(thePlayer.mcServer.worldServerForDimension(mod_TFmaterials.dimension)));
         }
         else {
                 thePlayer.timeUntilPortal = 10;
                 thePlayer.mcServer.getConfigurationManager().transferPlayerToDimension(thePlayer, 0, new TeleporterTF(thePlayer.mcServer.worldServerForDimension(0)));
         }
         }
}
@SideOnly(Side.CLIENT)
