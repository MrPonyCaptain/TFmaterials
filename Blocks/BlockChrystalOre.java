...
public class BlockChrystalOre extends Block{
private int itemToDrop;

public static BlockChrystalOre block;
...
public BlockChrystalOre(int i, int itemid)
{
...
{
    this.blockIcon = iconRegister.registerIcon("TFmaterials:ChrystalOre");
}
}
