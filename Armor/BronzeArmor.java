...
public String getArmorTextureFile(ItemStack itemstack) {
    if(itemstack.itemID == mod_TFmaterials.BronzeHelmet.itemID || itemstack.itemID == mod_TFmaterials.BronzeBody.itemID || itemstack.itemID == mod_TFmaterials.BronzeBoots.itemID){
    	return "/mods/TFmaterials/Armor/BronzeArmor_1.png";
    }

    if(itemstack.itemID == mod_TFmaterials.BronzeLegs.itemID){
    	return "/mods/TFmaterials/Armor/BronzeArmor_2.png";
    }
